...
void playMinion(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2) {
    int i, j;
...
void playSteward(struct gameState *state, int currentPlayer, int choice1, int choice2, int choice3, int handPos) {
